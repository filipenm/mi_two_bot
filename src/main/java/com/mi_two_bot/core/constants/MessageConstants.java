package com.mi_two_bot.core.constants;

public interface MessageConstants {
    String INVALID_COIN_PAIR = "Невалідна пара";
    String LIST_OF_COMMANDS = "Список можливих команд в менюшці " + EmojiConstants.DOWN_ARROW;
